...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_create_recipe_with_new_igredients(self):
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title='Pancakes with nutella')
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='Chicken with fries')
        r2 = create_recipe(user=self.user, title='Fish with tomatos')
        r3 = create_recipe(user=self.user, title='Rice with apples')

        i1 = Ingredient.objects.create(user=self.user, name='Pepper')
        i2 = Ingredient.objects.create(user=self.user, name='Salt')
